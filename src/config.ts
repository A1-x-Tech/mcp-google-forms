...
export const DEFAULT_BASE = "https://forms.googleapis.com";
...
export const MISSING_CREDENTIALS_MESSAGE =
  ...
  "GOOGLE_FORMS_ACCESS_TOKEN with a short-lived access token. " +
...
export function hasCredentials(config: GoogleFormsConfig): boolean {
